 ...
 * generated in the com.gzz.service package. 
...
public class ObjectFactory {
    ...
    private final static QName _Say_QNAME = new QName("http://service.gzz.com/", "say");
    private final static QName _SayResponse_QNAME = new QName("http://service.gzz.com/", "sayResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.gzz.service
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service.gzz.com/", name = "say")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service.gzz.com/", name = "sayResponse")
